...
public class Admin extends WorkWithFile
{
    ...
    public void admin_menu(RandomAccessFile userFile , RandomAccessFile flightFile , RandomAccessFile ticketFile ) throws IOException, InterruptedException
    {
        ...
        {
            case 1:
                add_flight(userFile , flightFile ,ticketFile);
                break;
            ...
            case 4:
                flight.flight_table(1 , userFile , flightFile ,ticketFile);
                break;
...
//        cls();
    ...
    else
    {
        ...
        long pricee = Long.valueOf(price) ;
        ...
        int seatss= Integer.valueOf(seats);
...
//            cls();
    ...
    void edit_flight(int flight_index, int mod , RandomAccessFile userFile , RandomAccessFile flightFile , RandomAccessFile ticketFile ) throws IOException, InterruptedException
    {
        ...
        {
            case 1:
                writeString((long) flight_index *FLIGHTLENGHT , flight_info , flightFile);
                break;
            case 2:
                writeString((long) flight_index *FLIGHTLENGHT + FIXSTRING , flight_info , flightFile);
                break;
            case 3:
                writeString((long) flight_index *FLIGHTLENGHT + 2*FIXSTRING, flight_info , flightFile);
                break;
            case 4:
                writeString((long) flight_index *FLIGHTLENGHT + 3*FIXSTRING, flight_info , flightFile);
                break;
            case 5:
                writeString((long) flight_index *FLIGHTLENGHT + 4*FIXSTRING, flight_info , flightFile);
                break;
            case 6:
...
//            cls();
        ...
        // delete flight
        writeString(flight_index*FLIGHTLENGHT , removed , flightFile);
        writeString(flight_index*FLIGHTLENGHT +   FIXSTRING, removed , flightFile);
        writeString(flight_index*FLIGHTLENGHT + 2*FIXSTRING, removed , flightFile);
        writeString(flight_index*FLIGHTLENGHT + 3*FIXSTRING, removed , flightFile);
        writeString(flight_index*FLIGHTLENGHT + 4*FIXSTRING, removed , flightFile);
